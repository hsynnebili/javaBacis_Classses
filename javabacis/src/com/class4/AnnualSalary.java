...
public class AnnualSalary {
	public static void main(String[] args) {
		...
		/*
		 * double workedYear = 5; double annualSalary1 = 200000;
		 * 
		 * Scanner scanner = new Scanner(System.in);
		 * System.out.println("How many years do you work in this company"); workedYear
		 * = scanner.nextDouble();
		 * 
		 * if (workedYear >= 4) { System.out.println("User is eligible for bonus");
		 * System.out.println("what is your annual salary"); annualSalary1 =
		 * scanner.nextDouble();
		 * 
		 * if (annualSalary1 > 50000) { System.out.println("User will get 5000 bonus");
		 * 
		 * } else { System.out.println("User will get 3000 bonus"); }
		 * 
		 * } else { System.out.println("User will not get bonus");
		 */
